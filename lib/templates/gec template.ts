...
<p style="font-size: 14px; line-height: 130%;"><span style="font-size: 16px; line-height: 20.8px; font-family: Lato, sans-serif;">You have successfully {{action}}ed for {{type}} of {{cName}}</span></p>
  </div>
